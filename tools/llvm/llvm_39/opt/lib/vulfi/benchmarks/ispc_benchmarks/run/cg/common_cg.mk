...
CMD1 = "-w $(n) array_in.dat result_$(EXAMPLE)_$(TARGET)_noerror.dat"
OUT1 = result_$(EXAMPLE)_$(TARGET)_noerror.dat

CMD2 = "-r $(n) array_in.dat result_$(EXAMPLE)_$(TARGET)_$(FSA)_error.dat"
...
ex1:
	...
	--cmd2 $(CMD2) \
	--out2 $(OUT2) \
	--iter $(ITER_CG) --pv --ff eql --fc 1 --fia $(FIA) \
